function out = LalChenSphereVert(theta,phi,a,R);
...
% Equation (5) of this paper and is for use in numerically integrating that
% function. 
%
% Syntax: out = LalChenSphereVert(theta,phi,a,R);
% 
...
rv = sqrt( (R.^2) - ((R-a).^2).*(sin(theta).^2) ) - (R-a).*cos(theta) ; % meters
